...
# Audio
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/configs/audio_effects.xml:system/etc/audio_effects.xml \
    $(COMMON_PATH)/configs/audio_policy_configuration.xml:system/etc/audio_policy_configuration.xml \
